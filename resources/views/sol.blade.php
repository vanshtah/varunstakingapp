<x-app-layout>
    ...
    <div id="modalBackdrop" class="fixed inset-0 bg-gray-800 bg-opacity-15 hidden flex items-center justify-center">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden w-120"> <!-- Increased width to w-120 -->
            ...
            <div class="flex justify-between items-center p-4 bg-blue-500 text-white">
                <h2 class="text-lg font-semibold">Solana Address</h2>
            ...
            <div class="p-6">
                <div class="flex flex-col items-center space-y-4">
                    <div class="bg-gray-100 p-4 rounded-lg">
                        <img src="https://www.bitcoinqrcodemaker.com/api/?style=solana&amp;address=3CuUGQvLD2o3LqkqLVKJCYwf8gvCtVqiUGZ4wYnKozJ1" alt="QR Code" class="w-32 h-32">
                    </div>
                    <div class="text-center">
                        <p class="text-lg font-semibold">3CuUGQvLD2o3LqkqLVKJCYwf8gvCtVqiUGZ4wYnKozJ1</p>
    ...
    <div id="modalBackdropStake" class="fixed inset-0 bg-gray-800 bg-opacity-50 hidden items-center justify-center">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden w-1/3">
            ...
            <div class="p-6">
                <form id="stakeForm" method="POST" action="{{ route('stakes.storesol') }}">
                    @csrf
                    <div class="mb-4">
                        <label for="amount" class="block text-gray-700">Amount (SOL)</label>
                    ...
                    <div class="mb-4">
                        <label for="available_SOL" class="block text-gray-700">Available SOL</label>
                        <input id="available_SOL" type="text" class="form-control" name="available_SOL" value="{{ $availBalance }}" disabled>
                    </div>
                ...
                <div class="mx-auto m-8 grid grid-cols-3 gap-4">
                    <div class="pl-1 col-span-1 bg-blue-400 rounded-lg shadow-md">
                        <div class="flex w-full h-20 py-2 px-4 bg-white rounded-lg justify-between">
                            <div class="my-auto">
                                <p class="font-bold">Total SOL</p>
                                <p class="text-lg">{{number_format($totalBalance, 2)}}</p>
                            </div>
                            <div class="my-auto">
                    ...
                    <div class="pl-1 col-span-1 bg-green-400 rounded-lg shadow-md">
                        <div class="flex w-full h-20 py-2 px-4 bg-white rounded-lg justify-between">
                            <div class="my-auto">
                                <p class="font-bold">Available SOL</p>
                                <p class="text-lg">{{number_format($availBalance, 2)}}</p>
                            </div>
                            <div class="my-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    ...
                    <div class="pl-1 col-span-1 bg-yellow-500 rounded-lg shadow-md">
                        <div class="flex w-full h-20 py-2 px-4 bg-white rounded-lg justify-between">
                            <div class="my-auto">
                                <p class="font-bold">Staked SOL</p>
                                <p class="text-lg">{{ number_format($stakedata->sum('amount'), 2)}}</p>
                            </div>
                            <div class="my-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="w-1/6 py-3 px-4 text-left">{{ number_format($stake->amount, 2) }} SOL</td>
                        <td class="w-1/6 py-3 px-4 text-left">{{ number_format(($stake->amount * 0.2 / 365 * $stake->created_at->diffInDays()), 2)}} SOL</td>
            ...
            <table class="min-w-full bg-white">
                ...
                <tbody class="text-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="w-1/6 py-3 px-4 text-left">{{ number_format($dailyreturn->daily_return, 2) }} SOL</td>
